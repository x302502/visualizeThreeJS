...
//         data['begintime'] = this.record_receipt.begintime;
//         data['endtime'] = this.record_receipt.endtime;
//         let counterror = 0;
//         let flag;
...
//                 for (let index = 0; index < this.data_rowdetail.length; index++) {
//                     let valuerow = this.data_rowdetail[index];
//                     let arr = this.data_rowdetail;
//                     if (parseInt(valuerow.status) == 0 || parseInt(valuerow.status) == 5) {
//                         valuerow['whseid'] = this.appServices.account.whseid;
//                         valuerow['username'] = this.appServices.account.username;
//                         let pack;
//                         let qtyexpected;
//                         this.data_pack.forEach((valuepack, indexpack, arrpack) => {
//                             if (valuerow.packkey == valuepack.packkey) {
//                                 pack = valuepack;
//                             }
//                         })
//                         if (pack && valuerow.uom == pack.packuom2) {
//                             if (pack.innerpack == 0 || pack.packuom2 == "") {
//                                 qtyexpected = valuerow.qtyexpected * 1;
//                             }
//                             qtyexpected = valuerow.qtyexpected * pack.innerpack;
//                         }
//                         $(this.tabDetail.nativeElement).tab('show');
//                         if (valuerow.uom == pack.packuom3) {
//                             qtyexpected = valuerow.qtyexpected * pack.qty;
//                         }
//                         if (valuerow.uom == pack.packuom4) {
//                             qtyexpected = valuerow.qtyexpected * pack.pallet;
//                         }
//                         valuerow['qtyReceipt'] = qtyexpected;
//                         await this.appServices.receipt({ 'obj': JSON.stringify(valuerow) }, this);
//                     }
...
//             this.appServices.receipt({ 'obj': JSON.stringify(this.record_receipt) }, this).then((res) => {
...
//                     let valuerow = this.data_rowdetail[index];
//                     let arr = this.data_rowdetail;
//                     if (valuerow.status == 9) {
//                         valuerow['whseid'] = this.appServices.account.whseid;
//                         valuerow['username'] = this.appServices.account.username;
//                         await this.appServices.unreceipt({ 'obj': JSON.stringify(valuerow) }, this);
//                     }
//                     await new Promise((resolve, reject) => {
//                         setTimeout(() => {
//                             resolve();
...
//                         await this.appServices.unreceipt({ 'obj': JSON.stringify(value) }, this);
//                     }
//                     await new Promise((resolve, reject) => {
//                         setTimeout(() => {
//                             resolve();
...
//     //                 valuerow['username'] = this.appServices.account.username;
//     //                 promises.push(new Promise((resolve, reject) => {
//     //                     this.appServices.unreceipt({ 'obj': JSON.stringify(valuerow) }, this).then((obj) => {
//     //                         resolve();
//     //                     }).catch(function (err) {
//     //                         reject(err);
//     //                     });
...
//     //                 value['username'] = this.appServices.account.username;
//     //                 promises.push(new Promise((resolve, reject) => {
//     //                     this.appServices.unreceipt({ 'obj': JSON.stringify(value) }, this).then((obj) => {
//     //                         resolve();
//     //                     }).catch(function (err) {
//     //                         reject(err);
//     //                     });
...
//         let storername = '';
//         if (this.appServices.account && (this.appServices.account.owners instanceof Array)) {
//             let storer = this.appServices.account.owners.find(e => e.storerkey === this.record_receipt.storerkey)
...
//     @ViewChild('modalLocation') child: PopupLocationComponent;
//     openModalLocation(i, id) {
//         this.child.openModal(i, id);
//     }
//     selectlocation(data) {
//         var locedit = data.locedit;
//         var i = data.i;
//         if (!locedit) {
//             $('#location').val(data.loc);
//             this.new_receiptdetail.toloc = data.loc;
//         } else {
//             $('#' + locedit + '').val(data.loc);
//             this.data_receiptdetail[i].toloc = data.loc
//         }
//         $('#locedit').val('')
//     }
